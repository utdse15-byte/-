# Edge 手机远程浏览器控制器 v6.8.6（程序 + AI 交接）
...
1. 打开 `01-程序`；
2. 源码仓库中程序位于 `01-程序/edge-phone-cdp-inherit-live/`，可直接运行；正式发布的 `edge-phone-cdp-inherit-live-v6.8.6.zip` 及其 SHA-256 由 CI 生成并发布到 GitHub Releases；
...
8. `01-程序/edge-phone-cdp-inherit-live/` 中的 `README-中文.md`、`更新说明-v6.8.6.md` 和 `发布验证报告.md`
